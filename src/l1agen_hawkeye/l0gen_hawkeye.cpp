...
int main (int argc, char* argv[])
{
  ...
  while (1) {
    ...
    //////////////////////////////////////////////
    int apid = ((*packet)[0] % 8) * 256 + (*packet)[1];
    if (apid == 2047) {
      ...
      while (priPacketLen == 2046 || priPacketLen == 2047) {
        framefile.read( (char *) frame, 892);
        priPacketLen = (frame[4] % 8) * 256 + frame[5];
      }
