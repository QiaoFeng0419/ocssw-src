...
double constrainLon(double lon) {
    ...
    while (lon < -180.0) {
        ...
        if (count > 10) {
            fprintf(stderr,
                    "-E- %s %d: constrainLon: longitude=%f way out of range.\n",
 ...
 * @return number of rows
 */
int64_t L3BinShape::getNumBins() const {
    return totalBins;
}
 ...
 */
void L3BinShape::bin2latlon(int64_t bin, float &lat, float &lon) {
    int32_t row, col;
 ...
 */
void L3BinShape::bin2bounds(int64_t bin,
 ...
 */
int64_t L3BinShapeInst::getBaseBin(int32_t row) const {
    constrainRow(row);
    return baseBin[row];
}
 ...
 */
int32_t L3BinShapeInst::bin2row(int64_t bin) {
 ...
 */
void L3BinShapeInst::bin2rowcol(int64_t bin, int32_t &row, int32_t &col) {
    if (bin < 1) {
 ...
 */
int64_t L3BinShapeInst::rowcol2bin(int32_t row, int32_t col) const {
 ...
 * @param lon center lon
 */
void L3BinShapeInst::rowcol2latlon(int32_t row, int32_t col,
 ...
 */
void L3BinShapeInst::latlon2rowcol(float lat, float lon,
 ...
 */
int64_t L3BinShapeInst::latlon2bin(float lat, float lon) const {
    int32_t row, col;
 ...
 * @param west extent of bin
 */
void L3BinShapeInst::rowcol2bounds(int32_t row, int32_t col,
        float &north, float &south,
