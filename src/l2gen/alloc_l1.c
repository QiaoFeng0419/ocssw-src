...
int32_t alloc_l1(filehandle* l1file, l1str *l1rec) {
    ...
    p += sizeof (float)*npix;
    l1rec->ws_unc = (float *) p;
    p += sizeof (float)*npix;
    l1rec->wd_unc = (float *) p;
    p += sizeof (float)*npix;
    l1rec->mw_unc = (float *) p;
    p += sizeof (float)*npix;
    l1rec->zw_unc = (float *) p;
    p += sizeof (float)*npix;
    l1rec->pr_unc = (float *) p;
    p += sizeof (float)*npix;
    l1rec->oz_unc = (float *) p;
    p += sizeof (float)*npix;
    l1rec->wv_unc = (float *) p;
    p += sizeof (float)*npix;
    l1rec->rh_unc = (float *) p;
    p += sizeof (float)*npix;
    l1rec->no2_tropo_unc = (float *) p;
    p += sizeof (float)*npix;
    l1rec->no2_strat_unc = (float *) p;
    p += sizeof (float)*npix;
