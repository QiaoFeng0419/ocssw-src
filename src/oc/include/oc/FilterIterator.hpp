#ifndef OC_FILTERITERATOR
#define OC_FILTERITERATOR
...
namespace oc {
    /*!
        ...
        documentation, it's only used for `oc::KvStore` for filtering values
        via group.
