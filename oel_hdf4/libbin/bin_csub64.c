...
int64_t *NUMBIN; // no. of bin in each row
double *LATBIN; // center latitude of each row
int64_t TOTBINS; // total bin numbers
int32_t NUMROWS; // total number of rows for binning
float SEAM_LON;
...
//void old_bin2ll(int32_t bin, float *lat, float *lon)
//{
//  int32_t row;
//  int32_t *tmpptr;
//
