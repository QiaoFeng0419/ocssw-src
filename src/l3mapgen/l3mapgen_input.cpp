...
int l3mapgen_init_options(clo_optionList_t* list, const char* softwareVersion) {
    ...
    clo_addOption(list, "projection", CLO_TYPE_STRING, "platecarree",
            ...
            "\n                   projection=\"+proj=aea +lat_1=55.0 +lat_2=65.0"
            "\n                         +lat_0=50.0 +lon_0=-154.0 +x_0=0 +y_0=0"
            "\n                         +ellps=GRS80 +datum=NAD83 +units=m\""
            "\n        gibs:      latitudinally dependent projection"
            "\n                   Plate Carre between 60S and 60N"
            "\n                   else use Polar Sterographic"
            "\n                   North Polar: projection=\"+proj=stere +lat_0=90"
            "\n                          +lat_ts=70 +lon_0=<central_meridian> +k=1"
            "\n                          +x_0=0 +y_0=0 +ellps=WGS84 +datum=WGS84 "
            "\n                          +units=m +no_defs\""
            "\n                   South Polar: projection=\"+proj=stere +lat_0=-90"
            "\n                          +lat_ts=-71 +lon_0=<central_meridian> +k=1"
            "\n                          +x_0=0 +y_0=0 +ellps=WGS84 +datum=WGS84 "
            "\n                          +units=m +no_defs\""
    ...
    clo_addOption(list, "trimNSEW", CLO_TYPE_BOOL, "yes",
    ...
    clo_addOption(list, "interp", CLO_TYPE_STRING, "nearest",
            ...
            //"\n        linear:  bi-linear interpolation using the corner coords of the"
            //"\n                  output pixel"
    ...
    clo_addOption(list, "full_latlon", CLO_TYPE_BOOL, "yes",
                  "write full latitude and longitude arrays (except for SMI)"
            "\n");
