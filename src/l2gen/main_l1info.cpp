...
int main(int argc, char *argv[]) {
    ...
    if ((l1file->sensorID == MODISA || l1file->sensorID == MODIST) &&
    ...
    int non_nadir = FALSE;
    int filledScans = 0;
    const char* instName = sensorId2InstrumentName(l1file->sensorID);
    if(instName && (strcmp(instName, "VIIRS") == 0)) {
    ...
    if (show_standard_info == TRUE) {
        ...
        if ((l1file->sensorID == VIIRSN) || (l1file->sensorID == VIIRSJ1)) {
