...
intn
#ifdef PROTOTYPE
writeindex(int32_t ndxid, int32_t *start_num, int32_t *begin, int32_t *extent,
        int32_t *maxbin)
#else
writeindex(ndxid, start_num, begin, extent, maxbin)
int32_t ndxid, *start_num, *begin, *extent, *maxbin;
#endif
{
    uchar8 *buffer, *b;
    double vs, hs;
...
int32_t *fstcall, prod_ID, mstrid, *slvid, nrec, *binno, *flags_set;
