...
/*! \enum oc::LogSeverity
    ...
    \brief Log severities, for use with oc::Log
...
/*!
    ...
    This is used internally for oc::Log and isn't meant for end users.
*/
//! \cond
class LogTarget {
    public:
    ...
    private:
        int min_severity_{LogSeverity::info};
        int max_severity_{LogSeverity::max};
