#ifndef OC_LEAPSECONDDATABASE
#define OC_LEAPSECONDDATABASE
...
namespace oc {
    ...
    */
    ...
    /*!
        \class oc::LeapSecondDatabase
    
        \brief Reader of leap second databases
    
        \section Example
        \snippet tests/leap_second_database.cpp oc::LeapSecond example
    */
