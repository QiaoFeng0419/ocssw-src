...
public:
    ...
    virtual int64_t latlon2bin(float lat, float lon) const;
    virtual void rowcol2bounds(int32_t row, int32_t col,
            float &north, float &south,
