...
#define GEOMSIZE        ((3*sizeof(int32_t))+(4*sizeof(double)))
#define NDXSIZE         ((5*sizeof(int32_t))+(2*sizeof(double)))
#define MSTRSIZE        ((3*sizeof(int16_t))+(2*sizeof(int32_t))+(sizeof(float))+(sizeof(int8_t)))
/*
#define MSTRSIZE        ((4*sizeof(int16_t))+(1*sizeof(int32_t))+(sizeof(float))+(sizeof(int8_t)))
#define MSTRSIZE        ((3*sizeof(int16_t))+(1*sizeof(int32_t))+(sizeof(float)))
 */
#define SLVSIZE         (2*sizeof(float))
