...
START_TEST(aqua) {
    ck_assert_file_format(getFormat("../l2gen/aqua/A2008080124500.L1B_LAC.subline"), FT_HMODISL1B, MODISA, MODIS_AQUA);
...
START_TEST(terra) {
    ck_assert_file_format(getFormat("../l2gen/terra/T2008080095000.L1B_LAC.subline"), FT_HMODISL1B, MODIST, MODIS_TERRA);
